...
class ReArrangeLibrary extends StatefulWidget {
  const ReArrangeLibrary({
    Key? key,
  }) : super(key: key);

  @override
  State<ReArrangeLibrary> createState() => _ReArrangeLibraryState();
}

class _ReArrangeLibraryState extends State<ReArrangeLibrary> {
          ...
          children: [
            Container(
                ...
                child: Column(children: [
                  ...
                  Expanded(child: getImage(libraryList[i].imgurl)),
                  Text(
                    libraryList[i].name,
                            ...
                            dragCompletion: (List<DraggableGridItem> list,
                              ...
                              setState(() {
                                final elementLibrary =
                                    libraryList.elementAt(beforeIndex);
                                libraryList.removeAt(beforeIndex);
                                libraryList.insert(afterIndex, elementLibrary);
